...
var file_greeter_v1_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil),  // 0: basic-service-invocation-py.greeter.v1.HelloRequest
	(*HelloResponse)(nil), // 1: basic-service-invocation-py.greeter.v1.HelloResponse
}
var file_greeter_v1_greeter_proto_depIdxs = []int32{
	0, // 0: basic-service-invocation-py.greeter.v1.Greeter.Hello:input_type -> basic-service-invocation-py.greeter.v1.HelloRequest
	1, // 1: basic-service-invocation-py.greeter.v1.Greeter.Hello:output_type -> basic-service-invocation-py.greeter.v1.HelloResponse
