...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='basic/greeter/v1/greeter.proto',
...
HelloRequest = _reflection.GeneratedProtocolMessageType('HelloRequest', (_message.Message,), {
  ...
  '__module__' : 'basic.greeter.v1.greeter_pb2'
