...
import (
	...
	"github.com/kzmake/examples/distributed-calculator/microservices/svc/subtractor/handler"
)
...
func newGRPCServer() *grpc.Server {
	...
	pb.RegisterSubtractorServer(s, handler.NewSubtractor(conn))
