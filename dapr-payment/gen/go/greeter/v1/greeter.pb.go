...
var file_greeter_v1_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil),  // 0: dapr-payment.greeter.v1.HelloRequest
	(*HelloResponse)(nil), // 1: dapr-payment.greeter.v1.HelloResponse
}
var file_greeter_v1_greeter_proto_depIdxs = []int32{
	0, // 0: dapr-payment.greeter.v1.Greeter.Hello:input_type -> dapr-payment.greeter.v1.HelloRequest
	1, // 1: dapr-payment.greeter.v1.Greeter.Hello:output_type -> dapr-payment.greeter.v1.HelloResponse
