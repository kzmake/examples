...
var file_echo_v1_echo_proto_goTypes = []interface{}{
	(*EchoRequest)(nil),  // 0: basic-service-invocation-py.echo.v1.EchoRequest
	(*EchoResponse)(nil), // 1: basic-service-invocation-py.echo.v1.EchoResponse
}
var file_echo_v1_echo_proto_depIdxs = []int32{
	0, // 0: basic-service-invocation-py.echo.v1.Echo.Echo:input_type -> basic-service-invocation-py.echo.v1.EchoRequest
	1, // 1: basic-service-invocation-py.echo.v1.Echo.Echo:output_type -> basic-service-invocation-py.echo.v1.EchoResponse
