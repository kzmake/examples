...
import (
	...
	pb "github.com/kzmake/examples/daprclock/gen/go/hourhand/v1"

	"github.com/kzmake/examples/daprclock/microservices/svc/hourhand/handler"
)
...
func newGRPCServer() *grpc.Server {
	...
	pb.RegisterHourHandServer(s, handler.NewHourHand())
