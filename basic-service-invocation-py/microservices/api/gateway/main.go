...
import (
	...
	echopb "github.com/kzmake/examples/basic-service-invocation-py/gen/go/echo/v1"
	greeterpb "github.com/kzmake/examples/basic-service-invocation-py/gen/go/greeter/v1"
)
