...
import email.v1.email_pb2


class EmailServiceBase(abc.ABC):

    @abc.abstractmethod
    async def Create(self, stream: 'grpclib.server.Stream[email.v1.email_pb2.CreateRequest, email.v1.email_pb2.CreateResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            '/basic.email.v1.EmailService/Create': grpclib.const.Handler(
                ...
                email.v1.email_pb2.CreateRequest,
                email.v1.email_pb2.CreateResponse,
            ),
        }
