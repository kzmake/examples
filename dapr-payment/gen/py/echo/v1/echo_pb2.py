...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='dapr-payment.echo.v1',
  syntax='proto3',
  serialized_options=b'Z+github.com/kzmake/examples/dapr-payment/api/echo/v1;echo',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x12\x65\x63ho/v1/echo.proto\x12\x10dapr-payment.echo.v1\x1a\x1cgoogle/api/annotations.proto\"\x1f\n\x0b\x45\x63hoRequest\x12\x10\n\x03msg\x18\x01 \x01(\tR\x03msg\" \n\x0c\x45\x63hoResponse\x12\x10\n\x03msg\x18\x01 \x01(\tR\x03msg2g\n\x04\x45\x63ho\x12_\n\x04\x45\x63ho\x12\x1d.dapr-payment.echo.v1.EchoRequest\x1a\x1e.dapr-payment.echo.v1.EchoResponse\"\x18\x82\xd3\xe4\x93\x02\x12\"\r/echo/v1/echo:\x01*B-Z+github.com/kzmake/examples/dapr-payment/api/echo/v1;echob\x06proto3'
  ,
...
_ECHOREQUEST = _descriptor.Descriptor(
  name='EchoRequest',
  full_name='dapr-payment.echo.v1.EchoRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='msg', full_name='dapr-payment.echo.v1.EchoRequest.msg', index=0,
...
_ECHORESPONSE = _descriptor.Descriptor(
  name='EchoResponse',
  full_name='dapr-payment.echo.v1.EchoResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='msg', full_name='dapr-payment.echo.v1.EchoResponse.msg', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
EchoRequest = _reflection.GeneratedProtocolMessageType('EchoRequest', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:dapr-payment.echo.v1.EchoRequest)
  })
...
EchoResponse = _reflection.GeneratedProtocolMessageType('EchoResponse', (_message.Message,), {
  ...
  '__module__' : 'echo.v1.echo_pb2'
  # @@protoc_insertion_point(class_scope:dapr-payment.echo.v1.EchoResponse)
  })
...
_ECHO = _descriptor.ServiceDescriptor(
  name='Echo',
  full_name='dapr-payment.echo.v1.Echo',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Echo',
    full_name='dapr-payment.echo.v1.Echo.Echo',
    index=0,
