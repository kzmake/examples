...
func (c *multiplierClient) Mul(ctx context.Context, in *MulRequest, opts ...grpc.CallOption) (*MulResponse, error) {
	out := new(MulResponse)
	err := c.cc.Invoke(ctx, "/distributedcalculator.multiplier.v1.Multiplier/Mul", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Multiplier_Mul_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/distributedcalculator.multiplier.v1.Multiplier/Mul",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MultiplierServer).Mul(ctx, req.(*MulRequest))
	}
...
var Multiplier_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "distributedcalculator.multiplier.v1.Multiplier",
	...
	Metadata: "multiplier/v1/multiplier.proto",
}
