...
import (
	...
	pb "github.com/kzmake/examples/daprclock/gen/go/secondhand/v1"

	"github.com/kzmake/examples/daprclock/microservices/svc/secondhand/handler"
)
...
func newGRPCServer() *grpc.Server {
	...
	h := handler.NewSecondHand(conn)
	pb.RegisterSecondHandServer(s, h)
